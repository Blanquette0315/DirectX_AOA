#ifndef _SHIELDEFFUPDATE
#define _SHIELDEFFUPDATE
...
[numthreads(128, 1, 1)]
void CS_ShieldEffUpdate(uint3 _id : SV_DispatchThreadID)
{
    ...
    if (0 == Particle.iActive)
    {
        ...
        if (Particle.iActive)
        {
            ...
            // 사각형 범위로 생성
            Particle.vRelativePos.xyz = vRandom.xyz * SpawnRange - (SpawnRange * 0.5f);
