...
CBagSlot0Script::CBagSlot0Script()
	: CSlotScript(BAGSLOT0SCRIPT)
{
}
...
void CBagSlot0Script::begin()
{
	CSlotScript::begin();
}

void CBagSlot0Script::tick()
{
	CSlotScript::tick();
}

void CBagSlot0Script::CreateDefaultItemCard()
{
	...
	tItem_Info tempItem = pPlayerScript->GetItemInfo(0);
...
void CBagSlot0Script::ChangeInfo(tItem_Info _Info)
{
	m_pUIMgrScript->GetGameMgrScript()->GetPlayerScript()->SetItemInfo(0, _Info);
}

void CBagSlot0Script::MouseCheck()
{
